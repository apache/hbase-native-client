...
function(download_folly SOURCE_DIR BINARY_DIR)
	...
	ExternalProject_Add(
		...
		CMAKE_ARGS ${PASSTHROUGH_CMAKE_ARGS}
				"-DCMAKE_INSTALL_PREFIX=${BINARY_DIR}/dependencies/facebook-folly-proj-install"
				-DCMAKE_POSITION_INDEPENDENT_CODE=ON
				"${BUILD_ARGS}"
		)


	set(FOLLY_ROOT_DIR "${BINARY_DIR}/dependencies/facebook-folly-proj-install" CACHE STRING "" FORCE)
